...
export const formatStatName = (stat) => {
  ...
  if (stat === 'fireResistancePercent') return 'Fire Resistance %';
  if (stat === 'coldResistancePercent') return 'Cold Resistance %';
  if (stat === 'airResistancePercent') return 'Air Resistance %';
