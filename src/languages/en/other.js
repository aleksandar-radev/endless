export default {
  ...
  'statistics.highestDamageTakenSurvived': 'Highest Damage Taken (Survived): {value}',
  ...
  'statistics.uniqueUniquesFound': 'Unique Items Discovered: {value} / {total}',
  ...
  'offline.history.title': 'Offline Progress History',
  'offline.history.empty': 'No offline progress recorded yet.',
  'offline.history.time': 'Time',
  'offline.history.duration': 'Duration',
  'offline.history.xp': 'XP',
  'offline.history.gold': 'Gold',
  'offline.history.items': 'Items',
  'offline.history.materials': 'Materials',
  'offline.history.details': 'Details',
  ...
  // Achievements
  'achievements.data.reach_level.title': 'Level Up',
  'achievements.data.reach_level.desc': 'Reach level {target}',
  'achievements.data.one_shot_kill.title': 'One Shot',
  'achievements.data.one_shot_kill.desc': 'Kill {target} enemies in a single hit',
  'achievements.data.summon_one_shot.title': 'Summon Power',
  'achievements.data.summon_one_shot.desc': 'Have a summon kill {target} enemies in a single hit',
  'achievements.data.find_unique_items.title': 'Collector',
  'achievements.data.find_unique_items.desc': 'Find {target} distinct unique items',
  'achievements.data.earn_gold.title': 'Accumulator',
  'achievements.data.earn_gold.desc': 'Earn {target} Gold',
  'achievements.data.deal_damage.title': 'Heavy Hitter',
  'achievements.data.deal_damage.desc': 'Deal {target} damage in a single hit',
  'achievements.data.survive_damage.title': 'Survivor',
  'achievements.data.survive_damage.desc': 'Survive a hit of {target} damage',
  'achievements.toast.completed': 'Achievement Completed: "{title}"!',
  'achievements.toast.upgraded': 'Achievement Upgraded! Now Level {level}',
  'achievements.toast.maxed': 'Achievement Maxed: "{title}"!',
  'achievements.toast.unlocked': 'Achievement Unlocked: "{title}"!',
};
