export default {
  ...
  'offline.history.title': '离线进度历史',
  'offline.history.empty': '尚无离线进度记录。',
  'offline.history.time': '时间',
  'offline.history.duration': '时长',
  'offline.history.xp': '经验',
  'offline.history.gold': '金币',
  'offline.history.items': '物品',
  'offline.history.materials': '材料',
  'offline.history.details': '详细信息',
