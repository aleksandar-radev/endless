...
export default {
  ...
  'crystalShop.upgrade.resetSkillTree.bonus': 'Reembolsa los puntos gastados en habilidades y reinicia tu clase',
  'crystalShop.upgrade.resetSkillTree.bonusLabel': 'Reinicia tu clase y devuelve los puntos gastados en habilidades. Las especializaciones permanecen bloqueadas hasta que las reinicies aparte.',
  'crystalShop.upgrade.resetSpecialization.label': 'Reiniciar Especialización',
  'crystalShop.upgrade.resetSpecialization.bonus': 'Reembolsa los puntos de especialización y borra tu elección',
  'crystalShop.upgrade.resetSpecialization.bonusLabel': 'Deshaz tu elección de especialización y recupera los puntos gastados para elegir otro camino.',
  ...
  'skillTree.tab.skills': 'Habilidades',
  'skillTree.tab.specializations': 'Especializaciones',
  'skillTree.specialization.selectHint': 'Desbloquea los pasos en orden para potenciar tus bonificaciones. El primer desbloqueo te compromete con ese camino.',
  'skillTree.specialization.lockWarningTitle': 'Un solo camino',
  'skillTree.specialization.lockWarning': 'Al desbloquear el primer paso se bloquearán las demás especializaciones hasta que las reinicies.',
  'skillTree.specialization.lockedOverlayTitle': 'Elección bloqueada',
  'skillTree.specialization.unavailable': 'Aún no hay especializaciones disponibles.',
  'skillTree.specialization.requiresLevelShort': 'Requiere Nv. {level}',
  'skillTree.specialization.cost': 'Costo: {cost} PH',
  'skillTree.specialization.unlockButton': 'Desbloquear',
  'skillTree.specialization.unlockedButton': 'Desbloqueado',
  'skillTree.specialization.lockedByChoice': 'Bloqueado porque otra especialización está activa.',
  'skillTree.specialization.lockedOverlay': '{name} está activa. Reinicia las especializaciones para elegir otro camino.',
  'skillTree.specialization.notEnoughPoints': 'No tienes puntos de habilidad suficientes para desbloquear este paso.',
  'skillTree.specialization.requiresLevel': 'Requiere nivel {level}.',
  'skillTree.specialization.requiresPrevious': 'Desbloquea los pasos anteriores para continuar.',
  'skillTree.specialization.statusSelected': 'Especialización activa',
  'skillTree.specialization.statusCompleted': 'Todos los pasos desbloqueados',
  'skillTree.specialization.statusLocked': 'Bloqueada por otra elección',
  'skillTree.specialization.statusAvailable': 'Lista para desbloquear',
  'skillTree.specialization.unlockSuccess': '¡{name} desbloqueada!',
  'skillTree.specialization.resetUnavailable': 'Aún no tienes una especialización que reiniciar.',
  'skillTree.specialization.sectionTitle': 'Especializaciones',
  'skillTree.specialization.previewDetail': 'Nv. {level} · {cost} PH',
  'skillTree.specialization.vanguard.name': 'Juramento de la Vanguardia',
  'skillTree.specialization.vanguard.description': 'Fortalece tus defensas con resistencia y perseverancia inquebrantables.',
  'skillTree.specialization.vanguard.step1.name': 'Entrenamiento de Bastión',
  'skillTree.specialization.vanguard.step1.description': '+15% Vida y +20% Armadura.',
  'skillTree.specialization.vanguard.step2.name': 'Espíritu Duradero',
  'skillTree.specialization.vanguard.step2.description': '+20% Regeneración de vida % y +5 de Probabilidad de bloqueo.',
  'skillTree.specialization.vanguard.step3.name': 'Bastión Inamovible',
  'skillTree.specialization.vanguard.step3.description': '+20% Vida % y +150 a Todas las resistencias.',
  'skillTree.specialization.predator.name': 'Senda del Depredador',
  'skillTree.specialization.predator.description': 'Enfócate en la agresión implacable y la caza constante de tus presas.',
  'skillTree.specialization.predator.step1.name': 'Asalto Implacable',
  'skillTree.specialization.predator.step1.description': '+15% Daño y +5% Prob. de crítico.',
  'skillTree.specialization.predator.step2.name': 'Instinto Asesino',
  'skillTree.specialization.predator.step2.description': '+10% Velocidad de ataque y +250 Puntuación de ataque.',
  'skillTree.specialization.predator.step3.name': 'Floritura Fatal',
  'skillTree.specialization.predator.step3.description': '+0.35 Multiplicador de daño crítico y +10% Daño.',
  'skillTree.specialization.arcane.name': 'Legado Arcano',
  'skillTree.specialization.arcane.description': 'Canaliza poder antiguo para ampliar tu maná y agudizar tu hechicería.',
  'skillTree.specialization.arcane.step1.name': 'Sabiduría Canalizada',
  'skillTree.specialization.arcane.step1.description': '+20% Maná y +2 de Regeneración de maná.',
  'skillTree.specialization.arcane.step2.name': 'Reservas de Foco',
  'skillTree.specialization.arcane.step2.description': '+10% Reducción de enfriamiento y +15% Daño elemental.',
  'skillTree.specialization.arcane.step3.name': 'Desborde de Esencia',
  'skillTree.specialization.arcane.step3.description': '+15% Maná y +10% Daño.',
  ...
  'crystalShop.confirm.resetSpecialization': '¿Reiniciar tu especialización y devolver los puntos de habilidad invertidos en sus pasos?<br>Esto costará <strong>{count} cristales</strong>.',
  ...
  'crystalShop.resetSpecializationSuccess': '¡Especialización reiniciada! Puedes elegir un nuevo camino.',
