...
export default {
  ...
  'options.scalingSystem.apply': 'Aplicar',
  'options.max': 'Máx',
  ...
  'tooltip.damageTakenReductionPercent': 'Reduce todo el daño recibido por un porcentaje (máx 30%).',
  ...
  'Glacial Bulwark': 'Baluarte Glacial',
  ...
  'stats.damageTakenReductionPercent': 'Reducción de Daño Recibido %',
  ...
  // Enemy Names
  'Mossback': 'Espalda de Musgo',
  'Thornling': 'Espinoso',
  'Barkhide': 'Corteza Dura',
  'Sylvan Wisp': 'Espíritu Silvestre',
  'Crystal Golem': 'Gólem de Cristal',
  'Gem Guardian': 'Guardián de Gemas',
  'Shardling': 'Fragmento',
  'Grimspike': 'Púas Sombrías',
  'Frostbite': 'Mordisco Helado',
  'Frostfury': 'Furia Helada',
  'Frostweaver': 'Tejedor de Escarcha',
  'Ice Wraith': 'Espectro de Hielo',
  'Dune Blazer': 'Llameante de Dunas',
  'Sandstalker': 'Acechador de Arena',
  'Dunewraith': 'Espectro de Dunas',
  'Scorching Salamander': 'Salamandra Abrasadora',
  'Boglurker': 'Acechador del Pantano',
  'Venomspitter': 'Escupe Veneno',
  'Toxictoad': 'Sapo Tóxico',
  'Shadowclaw': 'Garra Sombría',
  'Cloudstrider': 'Caminante de Nubes',
  'Thunderwing': 'Ala de Trueno',
  'Stormsoul': 'Alma de Tormenta',
  'Stormbringer': 'Portador de Tormentas',
  'Abyssal Wraith': 'Espectro Abismal',
  'Dreadfang': 'Colmillo del Terror',
  'Depths Leviathan': 'Leviatán de las Profundidades',
  'Wraith Lord': 'Señor Espectro',
  'Lava Elemental': 'Elemental de Lava',
  'Molten Wyrm': 'Sierpe Fundida',
  'Infernal Knight': 'Caballero Infernal',
  'Magma Titan': 'Titán de Magma',
  'Coral Sentinel': 'Centinela de Coral',
  'Tide Guardian': 'Guardián de las Mareas',
  'Wildfire Spirit': 'Espíritu de Fuego Salvaje',
  'Crimson Wisp': 'Espíritu Carmesí',
  'Phantom': 'Fantasma',
  'Banshee': 'Banshee',
  ...
  'Radiant Lion': 'León Radiante',
  'Solar Phoenix': 'Fénix Solar',
  'Obsidian Golem': 'Gólem de Obsidiana',
  'Arcane Construct': 'Constructo Arcano',
  'Void Sentinel': 'Centinela del Vacío',
  ...
  'Tempest Titan': 'Titán de la Tempestad',
  'Abyssal Leviathan': 'Leviatán Abismal',
  'Ember Sovereign': 'Soberano de Brasas',
  'Radiant Phoenix': 'Fénix Radiante',
  'Arcane Overseer': 'Supervisor Arcano',
  'Void Harbinger': 'Heraldo del Vacío',
  ...
  'Enchanted Forest': 'Bosque Encantado',
  'Crystal Cave': 'Cueva de Cristal',
  'Frozen Tundra': 'Tundra Congelada',
  'Scorching Desert': 'Desierto Abrasador',
  'Murky Swamp': 'Pantano Sombrío',
  'Skyrealm Peaks': 'Picos del Reino Celeste',
  'Abyssal Depths': 'Profundidades Abismales',
  'Volcanic Rift': 'Fisura Volcánica',
  'Sunken Ruins': 'Ruinas Hundidas',
  'Haunted Moor': 'Páramo Embrujado',
  'Golden Steppe': 'Estepa Dorada',
  'Obsidian Spire': 'Aguja de Obsidiana',
};
