...
export default {
  ...
  'skill.battleCry': 'Lanza un grito de batalla que aumenta temporalmente el daño, la velocidad de ataque y el robo de vida.',
  ...
  'soulShop.upgrade.bonusGold.label': '% de Oro Extra',
  'soulShop.upgrade.bonusExperience.label': '% de Experiencia Extra',
  'soulShop.upgrade.damageBoost.label': '% de Aumento de Daño',
  'soulShop.upgrade.attackRatingBoost.label': '% de Aumento de Puntuación de Ataque',
  'soulShop.upgrade.lifeBoost.label': '% de Aumento de Vida',
  'soulShop.upgrade.manaBoost.label': '% de Aumento de Maná',
  'soulShop.upgrade.armorBoost.label': '% de Aumento de Armadura',
  'soulShop.upgrade.evasionBoost.label': '% de Aumento de Evasión',
  'soulShop.upgrade.lifeRegenBoost.label': '% de Aumento de Regeneración de Vida',
  'soulShop.upgrade.allResistanceBoost.label': '% de Aumento de Resistencia Elemental',
  'soulShop.upgrade.extraMaterialDropPercent.label': '% de Probabilidad de Material Extra',
  'soulShop.upgrade.extraMaterialDropMax.label': 'Máx. de Material Extra',
