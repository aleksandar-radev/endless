...
export default {
  ...
  'options.scalingSystem': 'Sistema de Escalado',
  'options.scalingSystem.simple': 'Simple (Nuevo)',
  'options.scalingSystem.legacy': 'Legado (Antiguo)',
  'options.scalingSystem.tooltip': "Elige cómo escalan los enemigos y objetos en la región de Explorar. 'Simple' es el nuevo estándar.",
  'options.scalingSystem.reload': 'Recargar',
  ...
  'options.showAllStats.tooltip': 'Muestra todas las estadísticas disponibles',
  ...
  'options.showEnemyStats.tooltip': 'Muestra las estadísticas del enemigo durante el combate',
