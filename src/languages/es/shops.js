export default {
  ...
  'crystalShop.upgrade.startingStage.bonusLabel': 'Etapa inicial',
  'crystalShop.upgrade.stageSkip.label': 'Saltar Etapas',
  'crystalShop.upgrade.stageSkip.bonusLabel': 'Salto de etapa por muerte',
  ...
  'gamble.title': 'Tienda de Apuestas',
  'gamble.description': 'Gasta oro para recibir un objeto aleatorio. ¡Selecciona la categoría y apuesta! El nivel del objeto será aleatorio entre 1 y la etapa máxima alcanzada para esa categoría.',
  'gamble.tier': 'Categoría',
  'gamble.level': 'Nivel',
  'gamble.cost': 'Costo',
  'gamble.buy': '¡Apostar!',
  'gamble.notEnoughGold': '¡No hay suficiente oro!',
  'gamble.inventoryFull': '¡El inventario está lleno!',
  'gamble.stash': 'Reserva de Apuestas',
  'gamble.stashFull': '¡La reserva está llena! Mueve o vende objetos primero.',
  'gamble.moveToInventory': 'Mover',
  'gamble.sell': 'Vender',
  'gamble.moveAll': 'Mover Todo',
  'gamble.sellAll': 'Vender Todo',
};
