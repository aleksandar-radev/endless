export default {
  ...
  'offline.history.title': 'Historial de Progreso Offline',
  'offline.history.empty': 'Aún no hay registros de progreso offline.',
  'offline.history.time': 'Hora',
  'offline.history.duration': 'Duración',
  'offline.history.xp': 'XP',
  'offline.history.gold': 'Oro',
  'offline.history.items': 'Objetos',
  'offline.history.materials': 'Materiales',
  'offline.history.details': 'Detalles',
