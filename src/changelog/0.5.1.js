...
export default function run() {
  return html` <span style="color:#4F8A10;"> 2025-07-19</span>
    <hr />
    ...
    <ul>
      ...
      <li>
        Fixed a bug where prestiging was unlimited. Prestige now causes reload, to avoid issues with updating the whole
        UI.
      </li>
    </ul>`;
}
