...
export default function run() {
  return html`
    ...
    <ul>
      ...
      <li>
        Added a prestige card reroll option to randomize bonus values on a chosen card with an increasing crystal cost.
      </li>
      ...
      <li>
        Renamed Soul Shop upgrades to match their bonuses and doubled the Total Damage % upgrade cost while increasing
        its value to 1% per level.
      </li>
      <li>
        Added a Flat Penetration % stat and Soul Shop upgrade that boosts flat armor and elemental penetration by 5% per
        level.
      </li>
      ...
      <li>
        Expanded rune conversions to cover defensive, mana, evasion and resistance stats, and upgraded the rune
        inventory with 10 tabs plus shared frozen slots that are ignored by bulk salvage.
      </li>
      <li>
        Raised rocky field common rune drop chance, reshaped conversion rolls to produce a broader spread with rare
        100%+ highs, and reduced rune salvage crystal yields.
      </li>
      <li>
        Added a rune search filter that highlights matching slots and tabs and updated sorting to surface unique runes
        and the highest conversion rates first.
      </li>
      ...
      <li>
        Distribute Soul Shop max quick buys evenly across eligible upgrades instead of pouring all souls into the first
        picks.
      </li>
    ...
    <ul>
      ...
      <li>
        Rune conversions now operate on fully modified totals, so resource and resistance swaps transfer the expected
        amounts.
      </li>
      <li>
        Ensured conversion runes that touch damage stats also add their values to the destination stat instead of
        removing the source without a gain.
      </li>
      <li>Resolved equipped runes being shifted into frozen inventory slots after reloading.</li>
      <li>
        Stopped equipping duplicate runes simultaneously and fixed conversion stacking so each rune moves its full
        percentage from the original stat.
      </li>
    </ul>
  `;
}
