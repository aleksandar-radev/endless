...
<h3 style="color:#c42e2e; margin: 10px 0px;">Progress was not reset for this update, although, it is highly recommended
  to do so for optimal experience.</h3>
...
<ul>
  ...
  <li>Added new XP potion, that now provides % experience instead of flat amount. Reworked the existing greater xp
    potion to also provide % experience.</li>
  ...
  <li>Added Prestige system. Upon reaching some requirements, you can reset your progress and gain a reward that is
    persistent across prestiges.</li>
...
<ul>
  ...
  <li>Reduced strength inherit bonus to 0.34 (from 0.5). Reduced agility inherit bonus from 7 to 4 for attack rating,
    but it now also provides 0.2 damage.</li>
