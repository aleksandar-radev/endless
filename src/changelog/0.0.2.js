...
export default function run() {
  return html`
    ...
    <ul>
      ...
      <li>
        Material drop rates are now consistent across all stages, with extra material drops only from Soul Shop
        upgrades. (compared to previously where higher stages had increased drop rates)
      </li>
