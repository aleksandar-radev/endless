...
export default function run() {
  return html` <span style="color:#4F8A10;"> 2025-07-04</span>
    ...
    <ul>
      <li>
        <b>Leaderboard:</b> Added a new Leaderboard tab to view top players and their progress. (If you don't see
        yourself in the ranking, save your progress in the cloud again :))
      </li>
    </ul>
