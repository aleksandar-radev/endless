...
export default function run() {
  return html`
    ...
    <ul>
      ...
      <li>
        item stat scaling has been changed a little. Bonuses will scale a little faster on lower levels. Some modifiers
        have been increased (like armor, evasion, mana and others).
      </li>
      ...
      <li>
        Moved life regen from total % next to life regen in training, so all elemental damages show next to each other
        better on big screens.
      </li>
      ...
      <li>
        All options are now preserved between prestiges, apart from the ones that are purchased from the crystal shop.
      </li>
      ...
      <li>
        Increased maximum allowed size for save on server, so there should be no problems with saving progress anymore.
      </li>
      ...
      <li>
        Hero level ups performance improved, so gaining even 1k+ levels at once is now smoother and will not cause lag.
      </li>
    </ul>
