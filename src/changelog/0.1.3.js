...
export default function run() {
  return html`
    <span style="color:#4F8A10;"> 2025-06-17</span>
    ...
    <ul>
      <li>
        <b>Building Map for Offline Production:</b> <span style="color:gold;">Gold Mine</span>,
        <span style="color:lightblue;">Crystal Lab</span>, <span style="color:#B8860B;">Soul Forge</span> now generate
        resources over time, both in-game and offline.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        <b>Item Tier Scaling:</b> Item tier bonuses are now <span style="color:red;">4–8× lower</span> than before.
      </li>
    ...
    <span style="color:#32CD32;"> Fixes</span>
