...
export const UNIQUE_ITEMS = [
  {
    ...
    stats: [
      ...
      },
      {
        ...
        min: STATS.attackSpeedPercent.item.max * 8,
        max: STATS.attackSpeedPercent.item.max * 11,
      },
      {
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        min: STATS.fireDamagePercent.item.min * 4,
        max: STATS.fireDamagePercent.item.max * 6,
      },
      {
        stat: 'fireResistancePercent',
        min: STATS.fireResistancePercent.item.min * 3,
        max: STATS.fireResistancePercent.item.max * 5,
      },
    ],
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        min: STATS.elementalPenetration.item.min * 3,
        max: STATS.elementalPenetration.item.max * 4.5,
      },
      {
  ...
  },
  {
    ...
    stats: [
      {
        stat: 'attackSpeedPercent',
        min: STATS.attackSpeedPercent.item.min * 6,
        max: STATS.attackSpeedPercent.item.max * 9,
      },
      {
      ...
      },
      {
        ...
        min: STATS.chanceToHitPercent.item.min * 2.5,
        max: STATS.chanceToHitPercent.item.max * 3.5,
      },
    ],
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        min: STATS.allResistancePercent.item.min * 2.5,
        max: STATS.allResistancePercent.item.max * 4,
      },
      {
    ...
    items: [
      {
        ...
        stats: [
          ...
          },
          {
            ...
            min: STATS.lightningDamage.item.min * 2.8,
            max: STATS.lightningDamage.item.max * 1.6,
          },
          {
      ...
      },
      {
        ...
        stats: [
          ...
          },
          {
            ...
            min: STATS.manaRegenPercent.item.min * 1.5,
            max: STATS.manaRegenPercent.item.max * 0.9,
          },
        ],
      ...
      },
      {
        ...
        stats: [
          {
            stat: 'attackSpeedPercent',
            min: STATS.attackSpeedPercent.item.min,
            max: STATS.attackSpeedPercent.item.max * 0.7,
          },
          {
            stat: 'elementalDamagePercent',
            min: STATS.elementalDamagePercent.item.min * 6,
            max: STATS.elementalDamagePercent.item.max * 2.6,
          },
          {
    ...
    setBonuses: [
      {
        ...
        stats: [
          ...
          {
            stat: 'manaRegenPercent',
            min: STATS.manaRegenPercent.item.min * 2,
            max: STATS.manaRegenPercent.item.max * 1.2,
          },
        ],
      },
      {
        ...
        stats: [
          {
            stat: 'elementalDamagePercent',
            min: STATS.elementalDamagePercent.item.min * 8,
            max: STATS.elementalDamagePercent.item.max * 3.1,
          },
          {
            stat: 'elementalPenetration',
            min: STATS.elementalPenetration.item.min * 1.4,
            max: STATS.elementalPenetration.item.max * 0.9,
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        stats: [
          ...
          },
          {
            stat: 'allResistancePercent',
            min: STATS.allResistancePercent.item.min * 2.5,
            max: STATS.allResistancePercent.item.max * 1.1,
          },
          {
    ...
    setBonuses: [
      ...
      },
      {
        ...
        stats: [
          ...
          {
            stat: 'allResistancePercent',
            min: STATS.allResistancePercent.item.min * 3,
            max: STATS.allResistancePercent.item.max * 1.3,
          },
        ],
      },
      {
