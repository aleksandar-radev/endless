...
export const PALADIN_SKILLS = {
  ...
  // Tier 10,000 Skills
  sanctifiedBulwark: {
    id: 'sanctifiedBulwark',
    name: () => t('Sanctified Bulwark'),
    type: () => 'buff',
    manaCost: (level) => 150 + level * 2,
    cooldown: () => 160000,
    duration: () => 30000,
    requiredLevel: () => 10000,
    icon: () => 'sanctified-bulwark',
    description: () => t('skill.sanctifiedBulwark'),
    maxLevel: () => DEFAULT_MAX_SKILL_LEVEL,
    effect: (level) => ({
      armorPercent: scaleDownFlat(level, 10),
      blockChance: Math.min(scaleDownFlat(level, 0.2), 35),
      allResistance: scaleUpFlat(level, 10),
    }),
  },

  judgmentOfLight: {
    id: 'judgmentOfLight',
    name: () => t('Judgment of Light'),
    type: () => 'instant',
    skill_type: 'spell',
    manaCost: (level) => 200 + level * 3,
    cooldown: () => 26000,
    requiredLevel: () => 10000,
    icon: () => 'judgment-of-light',
    description: () => t('skill.judgmentOfLight'),
    maxLevel: () => DEFAULT_MAX_SKILL_LEVEL,
    effect: (level) => ({
      holyDamagePercent: scaleDownFlat(level, 9) * 4,
  ...
  seraphicGrace: {
    id: 'seraphicGrace',
    name: () => t('Seraphic Grace'),
    type: () => 'passive',
    requiredLevel: () => 25000,
    icon: () => 'seraphic-grace',
    description: () => t('skill.seraphicGrace'),
    maxLevel: () => DEFAULT_MAX_SKILL_LEVEL,
    effect: (level) => ({
      lifePercent: scaleDownFlat(level, 6),
  ...
  blazingRetribution: {
    id: 'blazingRetribution',
    name: () => t('Blazing Retribution'),
    type: () => 'instant',
    skill_type: 'spell',
    manaCost: (level) => 350 + level * 5,
    cooldown: () => 20000,
    requiredLevel: () => 25000,
    icon: () => 'blazing-retribution',
    description: () => t('skill.blazingRetribution'),
    maxLevel: () => DEFAULT_MAX_SKILL_LEVEL,
    effect: (level) => ({
      fireDamagePercent: scaleDownFlat(level, 10),
      lightningDamagePercent: scaleDownFlat(level, 10),
      holyDamagePercent: scaleDownFlat(level, 10),
    }),
  },
  ...
  divineEminence: {
    id: 'divineEminence',
    name: () => t('Divine Eminence'),
    type: () => 'buff',
    manaCost: (level) => 600 + level * 6,
    cooldown: () => 240000,
    duration: () => 45000,
    requiredLevel: () => 50000,
  },
