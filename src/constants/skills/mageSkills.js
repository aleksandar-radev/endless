...
export const MAGE_SKILLS = {
  ...
  voidBlast: {
    ...
    effect: (level) => ({
      ...
      reduceEnemyHpPercent: level * 0.05,
    }),
  },
  ...
  dimensionalRift: {
    ...
    effect: (level) => ({
      ...
      ignoreAllEnemyResistances: level * 0.1,
    }),
  },
  ...
  supremeSorcery: {
    ...
    maxLevel: () => DEFAULT_MAX_SKILL_LEVEL,
    effect: (level) => ({
      elementalDamagePercent: 6 * scaleDownFlat(level),
      manaPercent: 4 * scaleDownFlat(level),
      wisdomPercent: 5 * scaleDownFlat(level),
    }),
  },
  apocalypse: {
    id: 'apocalypse',
