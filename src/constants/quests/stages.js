...
const BASE_STAGE_QUESTS = [
  ...
  { target: 200, reward: { gold: 32000, crystals: 6 }, icon: `<img src="${BASE}/icons/earth.png" class="icon" alt="earth"/>` },
  { target: 300, reward: { gold: 40000, crystals: 8 }, icon: `<img src="${BASE}/icons/earth.png" class="icon" alt="earth"/>` },
