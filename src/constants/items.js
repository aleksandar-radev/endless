...
export const ITEM_ICONS = {
  HELMET: `<img src="${BASE}/icons/helmet.png" class="icon" alt="helmet"/>`,
  ARMOR: `<img src="${BASE}/icons/armor.png" class="icon" alt="armor"/>`,
  BELT: `<img src="${BASE}/icons/belt.png" class="icon" alt="belt"/>`,
  PANTS: `<img src="${BASE}/icons/pants.png" class="icon" alt="pants"/>`,
  BOOTS: `<img src="${BASE}/icons/boots.png" class="icon" alt="boots"/>`,
  SWORD: `<img src="${BASE}/icons/sword.png" class="icon" alt="sword"/>`,
  AXE: `<img src="${BASE}/icons/axe.png" class="icon" alt="axe"/>`,
  MACE: `<img src="${BASE}/icons/mace.png" class="icon" alt="mace"/>`,
  DAGGER: `<img src="${BASE}/icons/dagger.png" class="icon" alt="dagger"/>`,
  WAND: `<img src="${BASE}/icons/wand.png" class="icon" alt="wand"/>`,
  STAFF: `<img src="${BASE}/icons/staff.png" class="icon" alt="staff"/>`,
  SHIELD: `<img src="${BASE}/icons/shield.png" class="icon" alt="shield"/>`,
  BOW: `<img src="${BASE}/icons/bow.png" class="icon" alt="bow"/>`,
  ARROWS: `<img src="${BASE}/icons/arrows.png" class="icon" alt="arrows"/>`,
  GLOVES: `<img src="${BASE}/icons/gloves.png" class="icon" alt="gloves"/>`,
  AMULET: `<img src="${BASE}/icons/amulet.png" class="icon" alt="amulet"/>`,
  RING: `<img src="${BASE}/icons/ring.png" class="icon" alt="ring"/>`,
};
