...
export const RUNES = {
  ...
  empowering_rune: {
    ...
    stats: {
      damage: [20, 60],
      damagePerLevel: [0.5, 1.5],
      life: [200, 600],
      lifePerLevel: [5, 15],
      armor: [80, 240],
      armorPerLevel: [2, 6],
      attackRating: [120, 360],
      attackRatingPerLevel: [3, 9],
      evasion: [80, 240],
      evasionPerLevel: [2, 6],
      armorPenetration: [280, 600],
      armorPenetrationPerLevel: [5, 15],
      elementalPenetration: [280, 600],
      elementalPenetrationPerLevel: [5, 15],
      lifePerHit: [8, 32],
      lifePerHitPerLevel: [0.2, 0.8],
      mana: [80, 240],
      manaPerLevel: [2, 6],
      manaRegen: [4, 20],
      manaRegenPerLevel: [0.1, 0.5],
      lifeRegen: [20, 80],
      lifeRegenPerLevel: [0.5, 2],
    },
    attributes: 1,
    weight: 50000,
  ...
  cooldown_rune: {
    id: 'cooldown_rune',
    nameKey: 'rune.cooldownRune.name',
    descKey: 'rune.cooldownRune.desc',
    stats: { cooldownReductionPercent: [2, 10] },
    attributes: 1,
    weight: 350,
    icon: `${BASE}/icons/star.svg`,
    unique: false,
  ...
  buff_duration_rune: {
    id: 'buff_duration_rune',
    nameKey: 'rune.buffDurationRune.name',
    descKey: 'rune.buffDurationRune.desc',
    stats: { buffDurationPercent: [5, 25] },
    attributes: 1,
    weight: 500,
    icon: `${BASE}/icons/star.svg`,
    unique: false,
